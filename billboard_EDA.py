...
1. A big issue with this project is still the very small sample set on the Superbowl Headliners.
    In response to this, we decided to add in "negative samples" (i.e. declined headliners/declined guest performers -->
    artists who received offers to perform in the Superbowl but declined), reflected in superbowl_halftime_performers.csv
    file. 
    ...
    TODO: Check this part again; not sure if this is a good idea for training the model b/c it can be subjective
...
3. Average Score Stability
    ...
    out artists that would even be considered for the Superbowl.
        ...
        - Can potentially use this score to build the talent_pool_negatives.csv (i.e. talented artists that haven't
        officially receive an official offer from Roc Nation); This can be used to gain more data to train the model
        or a goof feature to look at in building the model
